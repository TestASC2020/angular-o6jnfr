...
import {QuotesActionMenuComponent} from './action-menu/quotes-action-menu.component';
import {CURRICULUMQUOTESSTATUS} from '../../../../../models/curriculum-quotes-status';
...
@Component({
    selector: 'app-cms-vendor-curriculum-quotes',
