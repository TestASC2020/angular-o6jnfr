...
@Component({
  selector: 'app-cms-vendor-curriculum-quiz-tf-view',
...
export class CurriculumQuizTfViewComponent implements OnInit {
  ...
  viewSolution() {
    ...
    this.router.navigate(['cms/vendor/curriculums/curriculum-view/curriculum-unit-list-edit/curriculum-question-view/edit-solution']);
  }
