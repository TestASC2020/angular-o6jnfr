...
@Component({
    selector: 'app-cms-vendor-question-solution-view',
    templateUrl: './question-solution-view.component.html',
    styleUrls: ['./question-solution-view.component.scss']
})
export class QuestionSolutionViewComponent implements OnInit {
    question: any;
    questionDetail: any;
    lastSolution: any;
    ...
    ngOnInit() {
        ...
        if (this.toRouters == null && this.cookieService.get('routLinks')) {
